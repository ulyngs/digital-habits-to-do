...
const tauriAPI = {
    ...
    async exitFullscreenFocus() {
        return this.invoke('exit_fullscreen_focus');
    },
    ...
    async exitFullscreenFocusToHome(taskId, completeOnHome = false, elapsedMs = null) {
        return this.invoke('exit_fullscreen_focus_to_home', {
            taskId,
            completeOnHome,
            elapsedMs
        });
